...
The resulting data will be used as a source to feed all the components of the digital marketing reporting applications that are built in Tableau Software (\ref{sec:tableau}).
\begin{figure}[h!]
  \center
